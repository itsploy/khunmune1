...
include('header.php');
	...
	{  
			...
			$objQuery = mysqli_query($objCon,$strSQL); 
				...
				echo("<script>window.location = 'bamee.php';</script>"); 
		 }  
              ...
              <div class=" col-lg-12 "  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000">  ประเภทก๋วยเตี๋ยว </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
						 ...
						 <form role="form" name="frmMain" method="post" action="save_bamee.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
                  		 ...
                  		 <div class="col-lg-12 ">   </div> 
							...
							<div class="form-group">
							   <font color = '#000' size="3px" > เส้นก๋วยเตี๋ยว </font>    
							</div>
						  </div>  
                 		     
						   <div class="col-md-10" style="margin-top: 0px; " >	
							<div class="form-group"> 
							  <input type="text" class="form-control" id="nametopping" name="nametopping"  autocomplete="off"      style="border-radius: 5px; border: 1px solid #C9C9C9; " placeholder=" เส้นเล็ก เส้นใหญ่ หมี่ขาว (ข้อมูลพื้นฐาน) "  >
							</div>
						  </div> 
                           ...
                           <div class="col-md-12" id="table_payment" >  
                 		     ...
                 		     <script language="javascript">
								 ...
								 { 
									...
									if(drop_topping == ""){
										alert( " กรุณาระบุกรอกรายการเส้นก๋วยเตี๋ยว " );
									}else{
										var jsonString = "";  
										$.ajax({
											type: "POST",
											url: "save_topping.php?drop_subject="+drop_topping,
                  		 ...
                  		 <div class="col-lg-12 ">   </div> 
                   		  <div class="col-md-12" style="margin-top: 0px; " >	
							<div class="form-group">
							   <font color = '#000' size="3px" > เครื่องเคียง (topping) </font>    
							</div>
						  </div>  
						   ...
						   <div class="col-md-10" style="margin-top: 0px; " >	
							<div class="form-group"> 
							  <input type="text" class="form-control" id="nametopping2" name="nametopping2"  autocomplete="off"      style="border-radius: 5px; border: 1px solid #C9C9C9; " placeholder=" หมูหมัก หมูชิ้น  "  >
							</div>
						  </div> 
                   		  <div class="col-md-2" style="margin-top: 0px; " >	
							<div class="form-group">  
							   <a onClick="save_drop2()"        >
								<button type="button" id="savedrop"  class="btn btn-sm btn-primary" style=" background-color: #5DC9C1; border-radius: 5px;   border-color: #FBFBFB; width: 100%; height: 40px;  " > 
								<font color="#FFF" size="2px" class="serif1" >  เพิ่ม   </font> 
								</button> </a>
							</div>
                           ...
                           <div class="col-md-12" id="table_payment2" >  
                 		     ...
                 		     <script language="javascript">
								 $( document ).ready(function() {   
							 	 ...
							 	 function getTabel_new_con2() { 
										$.ajax({
											type: "GET",
											url: "get_topping2.php",
											success: function(result) {
												$('#table_payment2').html(result);
											}
										});
									}
								     
								 /// ปุ่มลบ เรียกเป็น Class แถน 
								 $(document).on('click', '.btn-delete-fuck2', function() {
									var int1 = $(this).attr('data-id');

										// alert(int1);
										$.ajax({
											type: "POST",
											url: "delete_topping2.php",
											data: {del:int1},
											success: function( ) {  
											 getTabel_new_con2();  
											}
								 ...
								 function save_drop2()
								 { 
									var drop_topping = document.getElementById("nametopping2").value;
									  
									if(drop_topping == ""){
										alert( " กรุณาระบุกรอกรายการเครื่องเคียง (topping) " );
									}else{
										var jsonString = "";  
										$.ajax({
											type: "POST",
											url: "save_topping2.php?drop_subject="+drop_topping,
											contentType: 'application/json',
											data: jsonString,
											success: function( ) {  
												document.getElementById("nametopping2").value = "";
												getTabel_new_con2();  
										}
										}); 
									}
                  		 ...
                  		 <div class="col-lg-12 " style="margin-top: 25px;">   </div> 
                            ...
                            <div class="col-lg-12" align="left"   > 
                             ...
                             <div   class="col-lg-3"  align="left"> 
								...
								<tr>
									...
									<form action="bamee.php" method="get" >
                             ...
                             <div class="col-md-12" style="margin-top: 15px;" > 
								  <style>
											...
											$sql2 = "SELECT * FROM product where name != '' and typedata = 'ก๋วยเตี๋ยว'  ".$addcode.$addcode2."  order by pk asc    "; 
											...
											<?php if (ceil($total_record / $perpage) > 0): ?>
												<ul class="pagination">
																				<?php if ($page > 1): ?>
																				<li class="prev"><a href="bamee.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Prev</a></li>
																				<?php endif; ?>

																				<?php if ($page > 3): ?>
																				<li class="start"><a href="bamee.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">1</a></li>
																				<li class="dots">...</li>
																				<?php endif; ?>

																				<?php if ($page-2 > 0): ?><li class="page"><a href="bamee.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
																				<?php if ($page-1 > 0): ?><li class="page"><a href="bamee.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

																				<li class="currentpage"><a href="bamee.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page ?></a></li>

																				<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="bamee.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
																				<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="bamee.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)-2): ?>
																				<li class="dots">...</li>
																				<li class="end"><a href="bamee.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
																				<?php endif; ?>

																				<?php if ($page < ceil($total_record / $perpage)): ?>
																				<li class="next"><a href="bamee.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>">Next</a></li>
																				<?php endif; ?>
																			</ul>
											<?php endif; ?>
							...
							<tbody>
									<?php 
										...
										where name != ''   and typedata = 'ก๋วยเตี๋ยว'    ".$addcode.$addcode2."  
										...
										<div class="modal-dialog modal-md" role="document">
											...
											<div class="modal-body">
												  ...
												  <font size="3px" color="black">   
										        	...
										        	<hr>
													เครื่องเคียง (topping) <br> 
										        	<?php
													$i_ba = 1; 
													$bg = "#F8FAFD"; 
													$sql = "  
													SELECT *  FROM topping_bamee2  
													where name != ''  and bill_no = '".$objResult2["bill_no"]."'
													order by  pk asc "; 
													$query = mysqli_query($objCon,$sql); 
													while($objResult = mysqli_fetch_array($query))
										...
										<a  href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo $_SERVER["PHP_SELF"];?>?Action=Del2&CusID=<?php echo $objResult2["pk"];?>';}"  >
										  <font color="#000000" size="3px" class="serif1" style=" font-size: 13px; " >  ลบ  </font>  
											 ...
											 -
										<a href="bamee.php?CusID=<?php echo $objResult2["pk"];?>&page=1" ><font size="3px" color="red" style=" font-size: 13px; " > แก้ไข </font></a>   
                      ...
                      <?php } ?>
                       ...
                       <?php  
						...
						?> 
						 ...
						 <form role="form" name="frmMain" method="post" action="save_bamee_update.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
                 		     ...
                 		     <script language="javascript">
								 $( document ).ready(function() {   
							 	 ...
							 	 function getTabel_new_con() { 
									var get_bill_no = document.getElementById("bill_no").value; 
										$.ajax({
											type: "GET",
											url: "get_topping1_re.php?bill_no="+get_bill_no,
											success: function(result) {
												$('#table_payment').html(result);
											}
										});
								 ...
								 { 
									...
									if(drop_topping == ""){
										...
										$.ajax({
											type: "POST",
											url: "save_topping_re.php?drop_subject="+drop_topping+"&bill_no="+get_bill_no,
											contentType: 'application/json',
											data: jsonString,
											success: function( ) {  
												document.getElementById("nametopping").value = "";
                 		      ...
                 		      <script language="javascript">
								 $( document ).ready(function() {   
							 	 ...
							 	 function getTabel_new_con2() { 
									var get_bill_no = document.getElementById("bill_no").value; 
										$.ajax({
											type: "GET",
											url: "get_topping2_re.php?bill_no="+get_bill_no,
											success: function(result) {
												$('#table_payment2').html(result);
											}
										});
								 ...
								 { 
									...
									if(drop_topping == ""){
										...
										$.ajax({
											type: "POST",
											url: "save_topping2_re.php?drop_subject="+drop_topping+"&bill_no="+get_bill_no,
											contentType: 'application/json',
											data: jsonString,
											success: function( ) {  
												document.getElementById("nametopping2").value = "";
