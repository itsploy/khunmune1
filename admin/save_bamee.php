...
include("../database.php");
		...
		$update_img11 = "";
			...
			if(empty($check_image11)){
				...
				$check_image11 = "SGrimgbamee".rand(1,999)."img".rand(110000,999999).".png";
		...
		$strSQL = "INSERT INTO product (
		 name, price1, price2, img, bill_no, typedata 
		  ...
		  '".$_POST["name"]."',  '".$_POST["price1"]."', '".$_POST["price2"]."', '".$update_img11."', '".$bill_no."', 'ก๋วยเตี๋ยว' 
		)"; 
		$objQuery = mysqli_query($objCon, $strSQL);
			
			
		$strSQL = " Update topping_bamee1 Set  bill_no = '".$bill_no."'  " ;
		$strSQL .=" WHERE  bill_no = '' and create_by = '".$_SESSION["UserID"]."' "; 
		$objQuery = mysqli_query($objCon, $strSQL);	
			
		$strSQL = " Update topping_bamee2 Set  bill_no = '".$bill_no."'  " ;
		$strSQL .=" WHERE  bill_no = '' and create_by = '".$_SESSION["UserID"]."' "; 
		$objQuery = mysqli_query($objCon, $strSQL);	
