    ...
    <main class="flex-shrink-0 main has-footer">
            ...
            <div class="row">
                ...
                <div class="text-left col align-self-center">
                    <a class="navbar-brand" href="#">
                        <h5 class="mb-0"> ก๋วยเตี๋ยวเรือคุณหมื่น สูตรโบราณ </h5>
                    </a>
                </div>
        ...
        <div class="main-container">
                        ...
                        <div class="swiper-slide">
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body text-white">
                                    <h3 class="font-weight-normal"> ก๋วยเตี๋ยวเรือคุณหมื่น สูตรโบราณ</h3>
            ...
            <div class="col-md-12">
			 ...
			 <form role="form" name="frmMain" method="post" action="save_eatrice.php" enctype="multipart/form-data" onsubmit="return validateForm()"  > 
			 ...
			 <select  id="topping2" name="topping2"    style=" width: 100%; border-radius: 5px; font-size: 14px; height: 28px; padding-left: 3px; border: 1px solid #CBCBCB; "  >
				...
				<?php 
				$sql = "SELECT * FROM topping_bamee3 where pk = '".$topping2."' order by pk asc  "; 
				$query = mysqli_query($objCon,$sql);
				while($objResult = mysqli_fetch_array($query))
				{ 
				?>
